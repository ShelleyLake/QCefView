...
CefViewBrowserHandler::~CefViewBrowserHandler() {
  LOG(INFO) << "Exit Trace: ~CefViewBrowserHandler enter";
  LOG(INFO) << "Exit Trace: ~CefViewBrowserHandler leave";
}
...
void CefViewBrowserHandler::OnAddressChange(CefRefPtr<CefBrowser> browser,
...
bool CefViewBrowserHandler::OnJSDialog(CefRefPtr<CefBrowser> browser, const CefString &origin_url,
...
bool CefViewBrowserHandler::OnPreKeyEvent(CefRefPtr<CefBrowser> browser, const CefKeyEvent &event,
...
bool CefViewBrowserHandler::OnBeforePopup(
...
void CefViewBrowserHandler::OnBeforeClose(CefRefPtr<CefBrowser> browser) {
  ...
  if (pMainBrowser_ && pMainBrowser_->IsSame(browser)) {
    // if the main browser is closing, we need to close all the pop up
    // browsers.
  ...
  // Decrease the browser count
  {
    ...
    if (--browserCount_ == 0) {
      ...
      LOG(INFO) << "Exit Trace: OnBeforeClose";
      closeCV_.notify_all();
    }
  }
}

void CefViewBrowserHandler::OnLoadingStateChange(CefRefPtr<CefBrowser> browser, bool isLoading,
...
void CefViewBrowserHandler::OnLoadStart(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame,
...
void CefViewBrowserHandler::OnLoadEnd(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame,
                                      int httpStatusCode) {
  CEF_REQUIRE_UI_THREAD();
  QCefView *pCefView = GetCefView();
  if (pCefView)
...
void CefViewBrowserHandler::OnLoadError(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame,
...
bool CefViewBrowserHandler::OnBeforeBrowse(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame,
...
bool CefViewBrowserHandler::OnOpenURLFromTab(
    CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame, const CefString &target_url,
...
CefRefPtr<CefResourceRequestHandler> CefViewBrowserHandler::GetResourceRequestHandler(
...
void CefViewBrowserHandler::OnRenderProcessTerminated(CefRefPtr<CefBrowser> browser,
...
CefResourceRequestHandler::ReturnValue CefViewBrowserHandler::OnBeforeResourceLoad(
    CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame, CefRefPtr<CefRequest> request,
    CefRefPtr<CefRequestCallback> callback) {
...
CefViewBrowserHandler::GetResourceHandler(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame,
...
bool CefViewBrowserHandler::GetScreenPoint(CefRefPtr<CefBrowser> browser, int viewX, int viewY,
...
bool CefViewBrowserHandler::GetScreenInfo(CefRefPtr<CefBrowser> browser,
...
void CefViewBrowserHandler::OnCursorChange(CefRefPtr<CefBrowser> browser, CefCursorHandle cursor,
                                           CursorType type,
  ...
  if (!pCefView)
    return;
  SetClassLongPtr((HWND)pCefView->winId(), GCLP_HCURSOR,
                  static_cast<LONG>(reinterpret_cast<LONG_PTR>(cursor)));
  ::SetCursor(cursor);
}

void CefViewBrowserHandler::OnImeCompositionRangeChanged(
...
void CefViewBrowserHandler::CloseAllBrowsers(bool force_close) {
  std::unique_lock<std::mutex> lock(mtx_);
  LOG(INFO) << "Exit Trace: CloseAllBrowsers enter";
  ...
  if (pMainBrowser_) {
    ...
    LOG(INFO) << "Exit Trace: call CloseBrowser";
  }

  closeCV_.wait(lock);
  LOG(INFO) << "Exit Trace: CloseAllBrowsers leave";
}

bool CefViewBrowserHandler::TriggerEvent(const int64_t frame_id,
...
bool CefViewBrowserHandler::ResponseQuery(const int64_t query, bool success,
...
bool CefViewBrowserHandler::DispatchNotifyRequest(CefRefPtr<CefBrowser> browser,
                                                  CefProcessId source_process,
                                                  CefRefPtr<CefProcessMessage> message) {
...
void CefViewBrowserHandler::releaseImage() { imageMtx_.unlock(); }
