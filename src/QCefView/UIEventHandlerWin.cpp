...
UIEventHandlerWin::UIEventHandlerWin(HWND h, float deviceScaleFactor,
...
UIEventHandlerWin::~UIEventHandlerWin() {
  LOG(INFO) << "Exit Trace: ~UIEventHandlerWin enter";
  LOG(INFO) << "Exit Trace: ~UIEventHandlerWin leave";
}
